(function(global) {
    ...
    MyApp.MarkerMuseumManager = class MarkerMuseumManager {
        ...
        _createCoreManager(targetTimeRangeType, targetUrl) {
            ...
            var callbacks = {
                'tooltipContentCallback': MarkerMuseumManager._buildTooltipContent,
                'popupContentCallback': null,
                'filterGeojsonPredicate': MarkerMuseumManager._filterGeojsonPredicate,
            };
            var options = {
                shouldCircleMarker: false,
                circleMarkerColNames: null,
                shouldTooltip: true,
                tooltipNames: {className: 'tooltip-museum', geZoom: 'museumPointTooltipGeZoom', direction: 'museumPointTooltipDirection'},
                shouldPopup: false,
                popupNames: null,
                isCustomIconMarker: true,
                customIconUrl: 'images/museum_point.png',
            };
        ...
        static _buildTooltipContent(properties) {
            var content = `
<div>
    <div class="tooltip-museum-name">${properties.museumPointName}</div>
</div>
`;
            return content;
        }
...
`;
        ...
        static _filterGeojsonPredicate(properties) {
            if (properties.isMuseumPoint === true) {
                return true;
            }
            return false;
        }
